...
import static TrackBuddy.plugin.trackmate.io.IOUtils.readBooleanAttribute;
import static TrackBuddy.plugin.trackmate.io.IOUtils.readDoubleAttribute;
import static TrackBuddy.plugin.trackmate.io.IOUtils.readFloatAttribute;
import static TrackBuddy.plugin.trackmate.io.IOUtils.readIntAttribute;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys.FILTER_ABOVE_ATTRIBUTE_NAME;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys.FILTER_ELEMENT_KEY;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys.FILTER_FEATURE_ATTRIBUTE_NAME;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys.FILTER_VALUE_ATTRIBUTE_NAME;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys.TRACK_FILTER_COLLECTION_ELEMENT_KEY;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.FILTERED_BCellobject_COLLECTION_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.FILTERED_BCellobject_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.FILTERED_TRACK_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.FILTER_ABOVE_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.FILTER_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.FILTER_FEATURE_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.FILTER_VALUE_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.FRAME_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.IMAGE_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.IMAGE_FILENAME_v12_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.IMAGE_FOLDER_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.IMAGE_HEIGHT_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.IMAGE_NFRAMES_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.IMAGE_NSLICES_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.IMAGE_PIXEL_HEIGHT_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.IMAGE_PIXEL_WIDTH_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.IMAGE_SPATIAL_UNITS_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.IMAGE_TIME_INTERVAL_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.IMAGE_TIME_UNITS_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.IMAGE_VOXEL_DEPTH_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.IMAGE_WIDTH_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.INITIAL_BCellobject_FILTER_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.SEGMENTER_CLASS_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.SEGMENTER_SETTINGS_CLASS_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.SEGMENTER_SETTINGS_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.SETTINGS_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.SETTINGS_SEGMENTATION_CHANNEL_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.SETTINGS_TEND_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.SETTINGS_TSTART_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.SETTINGS_XEND_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.SETTINGS_XSTART_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.SETTINGS_YEND_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.SETTINGS_YSTART_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.SETTINGS_ZEND_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.SETTINGS_ZSTART_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.BCellobject_COLLECTION_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.BCellobject_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.BCellobject_FILTER_COLLECTION_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.BCellobject_FRAME_COLLECTION_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.BCellobject_ID_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.BCellobject_ID_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.BCellobject_NAME_v12_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.TRACKER_CLASS_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.TRACKER_SETTINGS_CLASS_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.TRACKER_SETTINGS_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.TRACK_COLLECTION_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.TRACK_EDGE_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.TRACK_EDGE_SOURCE_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.TRACK_EDGE_TARGET_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.TRACK_EDGE_WEIGHT_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.TRACK_ELEMENT_KEY_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.TRACK_ID_ATTRIBUTE_NAME_v12;
import static TrackBuddy.plugin.trackmate.io.TmXmlKeys_v12.TRACK_ID_ELEMENT_KEY_v12;
...
import TrackBuddy.plugin.trackmate.FeatureModel;
...
import TrackBuddy.plugin.trackmate.features.FeatureFilter;
...
import TrackBuddy.plugin.trackmate.features.track.TrackDurationAnalyzer;
import TrackBuddy.plugin.trackmate.gui.descriptors.ConfigureViewsDescriptor;
...
import TrackBuddy.plugin.trackmate.tracking.kdtree.NearestNeighborTrackerFactory;
import TrackBuddy.plugin.trackmate.tracking.oldlap.FastLAPTrackerFactory;
import TrackBuddy.plugin.trackmate.tracking.oldlap.SimpleFastLAPTrackerFactory;
...
public class TmXmlReader_v12 extends TmXmlReader
{
	...
	@Override
	public Collection< TrackMateModelView > getViews( final InteractiveAnalysis parent, final ViewProvider provider, final Model model, final Settings settings, final SelectionModel selectionModel )
	{
	...
	private void getTrackerSettings( final Settings settings, final TrackerProvider provider )
	{
		...
		else
		{
			...
			if ( trackerClassName.equals( "TrackBuddy.plugin.trackmate.tracking.SimpleFastLAPTracker" ) || trackerClassName.equals( "TrackBuddy.plugin.trackmate.tracking.SimpleLAPTracker" ) )
			{
				// convert to simple fast version
				trackerKey = SimpleFastLAPTrackerFactory.THIS2_TRACKER_KEY;
			}
			else if ( trackerClassName.equals( "TrackBuddy.plugin.trackmate.tracking.FastLAPTracker" ) || trackerClassName.equals( "TrackBuddy.plugin.trackmate.tracking.LAPTracker" ) )
			{
				// convert to fast version
				trackerKey = FastLAPTrackerFactory.THIS_TRACKER_KEY;
			}
			else if ( trackerClassName.equals( "TrackBuddy.plugin.trackmate.tracking.kdtree.NearestNeighborTracker" ) )
			{
		...
		// Deal with tracker settings
		{
			...
			else
			{
				...
				// All LAP trackers
				if ( trackerSettingsClassName.equals( "TrackBuddy.plugin.trackmate.tracking.LAPTrackerSettings" ) )
				{
				...
				else if ( trackerSettingsClassName.equals( "TrackBuddy.plugin.trackmate.tracking.kdtree.NearestNeighborTrackerSettings" ) )
				{
