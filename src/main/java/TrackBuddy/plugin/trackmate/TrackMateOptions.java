...
public class TrackMateOptions extends OptionsPlugin {
	...
	@Parameter(label = "Look-up table for scales", choices = { "Turbo", "Jet", "Viridis", "Algae", "Amp", "Balance",
			"Curl", "Deep", "Delta", "Dense", "Gray", "Haline", "Ice", "Matter", "Oxy", "Phase", "Solar", "Speed",
