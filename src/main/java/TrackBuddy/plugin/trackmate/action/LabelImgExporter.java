...
import TrackBuddy.plugin.trackmate.LoadTrackMatePlugIn_;
...
import TrackBuddy.plugin.trackmate.util.BCellobjectNeighborhood;
...
public class LabelImgExporter extends AbstractTMAction
{
	...
	private static final class BCellobjectAsDotWriter implements BCellobjectWriter
	{
		...
		public BCellobjectAsDotWriter( final InteractiveAnalysis parent,final ImgPlus< UnsignedShortType > img )
		{
