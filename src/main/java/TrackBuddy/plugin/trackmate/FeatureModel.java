...
public class FeatureModel {
	...
	protected FeatureModel(final Model model) {
		...
		declareBCellobjectFeatures(BCellobject.FEATURES, BCellobject.FEATURE_NAMES, BCellobject.FEATURE_SHORT_NAMES,
				BCellobject.FEATURE_DIMENSIONS, BCellobject.IS_INT);
	}
	...
	/*
	 * BCellobject FEATURES the BCellobject features are stored in the BCellobject
	 * object themselves, but we declare them here.
	 */

	/**
	 * Declares BCellobject features, by specifying their names, short name and
	 * dimension. An {@link IllegalArgumentException} will be thrown if any of the
	 ...
	 *            <code>true</code>) or <code>double</code>s (<code>false</code> ).
	 */
	public void declareBCellobjectFeatures(final Collection<String> features, final Map<String, String> featureNames,
			final Map<String, String> featureShortNames, final Map<String, Dimension> featureDimensions,
			final Map<String, Boolean> isIntFeature) {
	...
	/**
	 * Returns the name mapping of the BCellobject features that are dealt with in
	 * this model.
	 *
	...
	/**
	 * Returns the short name mapping of the BCellobject features that are dealt
	 * with in this model.
	 *
	...
	/**
	 * Returns the dimension mapping of the BCellobject features that are dealt with
	 * in this model.
	 *
	...
	public String toString() {
		...
		appendFeatureDeclarations(str, BCellobjectFeatures, BCellobjectFeatureNames, BCellobjectFeatureShortNames,
				BCellobjectFeatureDimensions, BCellobjectFeatureIsInt);
		str.append('\n');
