...
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.DEFAULT_HIGHLIGHT_COLOR;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.DEFAULT_BCellobject_COLOR;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.DEFAULT_TRACK_DISPLAY_DEPTH;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.DEFAULT_TRACK_DISPLAY_MODE;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.KEY_COLOR;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.KEY_COLORMAP;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.KEY_DISPLAY_BCellobject_NAMES;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.KEY_HIGHLIGHT_COLOR;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.KEY_BCellobjectS_VISIBLE;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.KEY_BCellobject_COLORING;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.KEY_BCellobject_RADIUS_RATIO;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.KEY_TRACKS_VISIBLE;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.KEY_TRACK_COLORING;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.KEY_TRACK_DISPLAY_DEPTH;
import static TrackBuddy.plugin.trackmate.visualization.TrackMateModelView.KEY_TRACK_DISPLAY_MODE;
...
import TrackBuddy.plugin.trackmate.gui.descriptors.StartDialogDescriptor;
...
import TrackBuddy.plugin.trackmate.action.AbstractTMAction;
import TrackBuddy.plugin.trackmate.action.ExportAllBCellobjectsStatsAction;
import TrackBuddy.plugin.trackmate.action.ExportStatsToIJAction;
import TrackBuddy.plugin.trackmate.features.ModelFeatureUpdater;
...
import TrackBuddy.plugin.trackmate.gui.descriptors.ActionChooserDescriptor;
import TrackBuddy.plugin.trackmate.gui.descriptors.BCellobjectFilterDescriptor;
import TrackBuddy.plugin.trackmate.gui.descriptors.ConfigureViewsDescriptor;
import TrackBuddy.plugin.trackmate.gui.descriptors.GrapherDescriptor;
import TrackBuddy.plugin.trackmate.gui.descriptors.LoadDescriptor;
import TrackBuddy.plugin.trackmate.gui.descriptors.LogPanelDescriptor;
import TrackBuddy.plugin.trackmate.gui.descriptors.SaveDescriptor;
import TrackBuddy.plugin.trackmate.gui.descriptors.SomeDialogDescriptor;
import TrackBuddy.plugin.trackmate.gui.descriptors.TrackFilterDescriptor;
import TrackBuddy.plugin.trackmate.gui.descriptors.TrackerChoiceDescriptor;
import TrackBuddy.plugin.trackmate.gui.descriptors.TrackerConfigurationDescriptor;
import TrackBuddy.plugin.trackmate.gui.descriptors.TrackingDescriptor;
import TrackBuddy.plugin.trackmate.gui.descriptors.ViewChoiceDescriptor;
import TrackBuddy.plugin.trackmate.gui.descriptors.WizardPanelDescriptor;
import TrackBuddy.plugin.trackmate.gui.panels.components.ColorByFeatureGUIPanel;
...
import TrackBuddy.plugin.trackmate.tracking.ManualTrackerFactory;
...
public class TrackMateGUIController implements ActionListener
{
	...
	public TrackMateGUIController(final InteractiveAnalysis parent, final TrackMate trackmate )
	{
	 ...
	 */
	public TrackMateGUIController createOn(final InteractiveAnalysis parent, final TrackMate lTrackmate )
	{
	 ...
	 * {@link TrackBuddy.plugin.trackmate.SelectionChangeListener}s controlled by this
	 * instance.
	 *
	 ...
	 * {@link TrackBuddy.plugin.trackmate.detection.BCellobjectDetectorFactory}s to this GUI
	 *
	 ...
	 * {@link TrackBuddy.plugin.trackmate.features.BCellobject.BCellobjectAnalyzerFactory}s to this
	 * GUI.
	 *
	 ...
	 * {@link TrackBuddy.plugin.trackmate.features.edges.EdgeAnalyzer}s to this GUI.
	 *
	 ...
	 * {@link TrackBuddy.plugin.trackmate.features.track.TrackAnalyzer}s to this GUI.
	 *
	 ...
	 * {@link TrackBuddy.plugin.trackmate.tracking.BCellobjectTracker}s to this GUI.
	 *
