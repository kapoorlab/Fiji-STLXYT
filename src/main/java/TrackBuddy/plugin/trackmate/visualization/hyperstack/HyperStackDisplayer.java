...
import TrackBuddy.plugin.trackmate.ModelChangeEvent;
import TrackBuddy.plugin.trackmate.SelectionChangeEvent;
import TrackBuddy.plugin.trackmate.SelectionModel;
import TrackBuddy.plugin.trackmate.visualization.AbstractTrackMateModelView;
...
import TrackBuddy.plugin.trackmate.visualization.ViewUtils;
...
public class HyperStackDisplayer extends AbstractTrackMateModelView
{
	...
	public InteractiveAnalysis parent;
	...
	public HyperStackDisplayer(final InteractiveAnalysis parent, final Model model, final SelectionModel selectionModel, final ImagePlus imp )
	{
	...
	public HyperStackDisplayer( final InteractiveAnalysis parent, final Model model, final SelectionModel selectionModel )
	{
