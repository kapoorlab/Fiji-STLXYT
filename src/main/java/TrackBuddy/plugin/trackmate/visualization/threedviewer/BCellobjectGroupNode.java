...
public class BCellobjectGroupNode< K > extends ContentNode
{
	 ...
	 */
	protected Switch BCellobjectSwitch;

	/**
	 * Switch used for BCellobject names display.
	 */
	protected Switch textSwitch;

	/**
	 * Boolean set that controls the visibility of each BCellobject.
	 */
	protected BitSet switchMask;

	/**
	 * Map that links the BCellobject keys to their indices in the Switch.
	 *
	...
	/**
	 * Re-create the {@link #meshes} field with BCellobject meshes, from the fields
