...
import TrackBuddy.plugin.trackmate.ModelChangeListener;
...
public abstract class AbstractTrackMateModelView implements SelectionChangeListener, TrackMateModelView, ModelChangeListener
{
	...
	protected AbstractTrackMateModelView( InteractiveAnalysis parent, final Model model, final SelectionModel selectionModel )
	{
