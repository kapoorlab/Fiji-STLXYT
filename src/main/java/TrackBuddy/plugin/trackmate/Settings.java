...
import TrackBuddy.plugin.trackmate.features.FeatureAnalyzer;
...
public class Settings {
	 ...
	 * {@link TrackBuddy.plugin.trackmate.visualization.TrackMateModelView} as a GUI
	 * target.
	 */
	 ...
	 * {@link TrackBuddy.plugin.trackmate.detection.BCellobjectDetector} for each target
	 * frame.
	 */
	...
	/**
	 * Settings map for {@link TrackBuddy.plugin.trackmate.detection.BCellobjectDetector}.
	 * 
	 * @see TrackBuddy.plugin.trackmate.detection.DetectorKeys
	 */
	public Map<String, Object> detectorSettings = new HashMap<>();

	/**
	 * Settings map for {@link TrackBuddy.plugin.trackmate.tracking.BCellobjectTracker}.
	 * 
	 * @see TrackBuddy.plugin.trackmate.tracking.TrackerKeys
	 */
	 ...
	 *            the
	 *            {@link TrackBuddy.plugin.trackmate.features.BCellobject.BCellobjectAnalyzer}
