package TrackBuddy.plugin.trackmate.features.track;
...
public class TrackBCellobjectQualityFeatureAnalyzer implements TrackAnalyzer
{

	/*
	 * CONSTANTS
	 */
	public static final String KEY = "TRACK_BCellobject_QUALITY";
	...
	public TrackBCellobjectQualityFeatureAnalyzer()
	{
		setNumThreads();
	}
	...
	public void process( final Collection< Integer > trackIDs, final Model model )
	{
		...
		{
			threads[ i ] = new Thread( "TrackBCellobjectFeatureAnalyzer thread " + i )
			{
