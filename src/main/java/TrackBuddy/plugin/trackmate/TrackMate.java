...
import TrackBuddy.plugin.trackmate.features.BCellobjectFeatureCalculator;
import TrackBuddy.plugin.trackmate.features.EdgeFeatureCalculator;
import TrackBuddy.plugin.trackmate.features.FeatureFilter;
import TrackBuddy.plugin.trackmate.features.TrackFeatureCalculator;
...
public class TrackMate implements Benchmark, MultiThreaded, Algorithm {
	...
	protected InteractiveAnalysis parent;
	...
	public TrackMate(final InteractiveAnalysis parent, final Model model, final Settings settings) {
	 ...
	 */
	protected List<BCellobject> translateAndPruneBCellobjects(final InteractiveAnalysis parent, final List<BCellobject> BCellobjectsThisFrame,
	...
	public boolean execTracking() {
		...
		final BCellobjectTracker tracker = settings.trackerFactory.create(parent.cells, settings.trackerSettings);
		...
		System.out.println(parent.Allcells.keySet().size() + " Parent " + model.BCellobjects.keySet().size());
	...
	public boolean execDetection() {
		...
		model.setBCellobjects(parent.cells, true);
