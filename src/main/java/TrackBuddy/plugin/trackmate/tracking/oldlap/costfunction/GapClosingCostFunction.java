package TrackBuddy.plugin.trackmate.tracking.oldlap.costfunction;
...
public class GapClosingCostFunction extends MultiThreadedBenchmarkAlgorithm implements OutputAlgorithm< Matrix >
{
	...
	public GapClosingCostFunction( final Map< String, Object > settings, final List< SortedSet< BCellobject > > trackSegments )
	{
