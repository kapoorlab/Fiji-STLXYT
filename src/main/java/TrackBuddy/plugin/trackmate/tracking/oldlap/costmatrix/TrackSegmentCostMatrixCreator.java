package TrackBuddy.plugin.trackmate.tracking.oldlap.costmatrix;
...
import TrackBuddy.plugin.trackmate.tracking.oldlap.costfunction.GapClosingCostFunction;
import TrackBuddy.plugin.trackmate.tracking.oldlap.costfunction.MergingCostFunction;
import TrackBuddy.plugin.trackmate.tracking.oldlap.costfunction.SplittingCostFunction;
...
public class TrackSegmentCostMatrixCreator extends LAPTrackerCostMatrixCreator {
	...
	public TrackSegmentCostMatrixCreator(final List<SortedSet<BCellobject>> trackSegments, final Map<String, Object> settings) {
		super(settings);
