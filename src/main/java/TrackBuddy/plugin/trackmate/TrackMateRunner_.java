...
import TrackBuddy.plugin.trackmate.action.ExportTracksToXML;
...
import TrackBuddy.plugin.trackmate.io.TmXmlWriter;
...
import TrackBuddy.plugin.trackmate.tracking.TrackerKeys;
import TrackBuddy.plugin.trackmate.tracking.sparselap.SimpleSparseLAPTrackerFactory;
import TrackBuddy.plugin.trackmate.util.LogRecorder;
...
import TrackBuddy.plugin.trackmate.visualization.hyperstack.HyperStackDisplayerFactory;
...
public class TrackMateRunner_ extends TrackMatePlugIn_ {
	...
	public TrackMateRunner_(InteractiveAnalysis parent) {
		super(parent);
		this.parent = parent;
	}
	 ...
	 * {@link TrackBuddy.plugin.trackmate.action.ExportTracksToXML}. Is ignored if the
	 * {@link #ARG_USE_GUI} is set to <code>true</code>.
	 */
